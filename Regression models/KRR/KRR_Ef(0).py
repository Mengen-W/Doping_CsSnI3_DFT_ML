...
'''
best_kernel = RationalQuadratic(alpha=4.64, length_scale=1.67)
best_alpha = 1e-1  
...
with open('Predictions_KRR_E_form(0).txt', 'w') as f:
    f.write("Dopant, Predicted Formation Energy\n")
    
    for i in range(n_out):
        f.write(f"{dopant_out[i]}, {Pred_E_form[i]:.4f}\n")

print("Predictions have been saved to 'Predictions_KRR_E_form(0).txt'.")